...
//public class DefaultGitlabClientTests {
//
...
//    private DefaultGitlabClient defaultHudsonClient;
//
...
//        settings = new GitlabSettings();
//        settings.setPageSize(PAGE_SIZE);
//        gitlabClient = defaultHudsonClient = new DefaultGitlabClient(restOperationsSupplier,
//                settings);
//    }
//
//    @Test
//    public void joinURLsTest() throws Exception {
//        String u = DefaultGitlabClient.joinURL("http://gitlab.com",
//                new String[]{"/api/json?tree=jobs[name,url,builds[number,url]]"});
//        assertEquals("http://gitlab.com/api/json?tree=jobs[name,url,builds[number,url]]", u);
//
//        String u4 = DefaultGitlabClient.joinURL("http://gitlab.com/", new String[]{"test", "/api/json?tree=jobs[name,url,builds[number,url]]"});
//        assertEquals("http://gitlab.com/test/api/json?tree=jobs[name,url,builds[number,url]]", u4);
//
//        String u2 = DefaultGitlabClient.joinURL("http://gitlab.com/", new String[]{"/test/", "/api/json?tree=jobs[name,url,builds[number,url]]"});
//        assertEquals("http://gitlab.com/test/api/json?tree=jobs[name,url,builds[number,url]]", u2);
//
//        String u3 = DefaultGitlabClient.joinURL("http://gitlab.com", new String[]{"///test", "/api/json?tree=jobs[name,url,builds[number,url]]"});
//        assertEquals("http://gitlab.com/test/api/json?tree=jobs[name,url,builds[number,url]]", u3);
//    }
//
//    @Test
//    public void rebuildURLTest() throws Exception {
//
//        String u1 = DefaultGitlabClient.rebuildJobUrl("http://gitlab.com/job/job1", "https://123456:234567@gitlab.com");
//        assertEquals("https://123456:234567@gitlab.com/job/job1", u1);
//
//        String u2 = DefaultGitlabClient.rebuildJobUrl("https://gitlab.com/job/job1", "https://123456:234567@gitlab.com");
//        assertEquals("https://123456:234567@gitlab.com/job/job1", u2);
//
//        String u3 = DefaultGitlabClient.rebuildJobUrl("http://gitlab.com/job/job1", "http://123456:234567@gitlab.com");
//        assertEquals("http://123456:234567@gitlab.com/job/job1", u3);
//
//        String u4 = DefaultGitlabClient.rebuildJobUrl("http://gitlab.com/job/job1", "http://123456:234567@gitlab.com");
//        assertEquals("http://123456:234567@gitlab.com/job/job1", u4);
//
//        String orig = "http://gitlab.com/job/job1%20with%20space";
//        String u5 = DefaultGitlabClient.rebuildJobUrl(orig, "http://gitlab.com");
...
//		URL u = new URL(new URL("http://gitlab.com"), "/api/json?tree=jobs[name,url," +
//                "builds[number,url]]");
//
...
//
//        List<String> servers = Collections.singletonList("http://user:pass@gitlab.com");
...
//        defaultHudsonClient.makeRestCall("http://user:pass@gitlab.com");
...
//        settings.setUsernames(usernames);
//        settings.setApiKeys(apiKeys);
//        defaultHudsonClient.makeRestCall("http://gitlab.com");
//        verify(rest).exchange(Matchers.any(URI.class), eq(HttpMethod.GET),
//                eq(headers), eq(String.class));
//    }
//
...
//        settings.setUsernames(usernames);
//        settings.setApiKeys(apiKeys);
//        defaultHudsonClient.getLog("http://gitlab.com");
//        verify(rest).exchange(eq(URI.create("http://gitlab.com/consoleText")), eq(HttpMethod.GET),
//                eq(headers), eq(String.class));
//    }
//
//    @Test
...
//                .thenReturn(new ResponseEntity<>("", HttpStatus.OK));
//
//        Map<GitlabProject, Map<GitlabClient.jobData, Set<BaseModel>>> jobs = gitlabClient.getInstanceProjects(URL_TEST);
//
...
//        Iterator<GitlabProject> jobIt = jobs.keySet().iterator();
//
//        //First job
//        GitlabProject job = jobIt.next();
//        assertJob(job, "job1", "http://server/job/job1/");
//
//        Iterator<BaseModel> buildIt = jobs.get(job).get(GitlabClient.jobData.BUILD).iterator();
...
//
//        buildIt = jobs.get(job).get(GitlabClient.jobData.BUILD).iterator();
...
//
//        Build build = gitlabClient.getPipelineDetails("http://server/job/job2/2/", "http://server");
//
...
//
//        Build build = gitlabClient.getPipelineDetails("http://localhost/job/Hygieia-Common/179/", "http://localhost");
//
//        assertThat(build.getTimestamp(), notNullValue());
...
//        InputStream inputStream = DefaultGitlabClientTests.class.getResourceAsStream(fileName);
//        return IOUtils.toString(inputStream);
//    }
//
//    private void assertJob(GitlabProject job, String name, String url) {
